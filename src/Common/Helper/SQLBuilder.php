...
class SQLBuilder
{
    public static function insert(string $table, array $row)
    {
    ...
    public static function inserts(string $table, array $rows)
    {
		$holds = array();
    ...
    public static function select(array $columns, string $table, array $where, int $offset=0, int $length=0)
    {
    ...
    public static function update(string $table, array $feilds, array $where)
    {
		$set = array();
        $vals = array();
	...
	public static function delete($table, array $where, $limit=0)
	{
        $tmp = array();
	...
	public static function where(array $where, array &$tmp)
	{
		$_where = array();
